...
def get_args():
    ...
    # my addition
    parser.add_argument('-sent_num',
                        type=int,
                        default=30,
                        help='max sentence length for model')
    # Basics
    ...
    # Whether to use sentence module or key sentence module
    parser.add_argument('-use_sentence',
                        type='bool',
                        default=False,
                        help='whether to use the sentence module')

    parser.add_argument('-use_key_sentence',
                        type='bool',
                        default=False,
                        help='whether to use the key sentence module')
